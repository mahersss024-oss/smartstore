...
$classes = Flux::classes()
    ...
    ->add(match ($size) {
        'lg' => 'text-sm px-3 py-1.5 **:data-flux-badge-icon:me-2',
        default => 'text-sm px-2 py-1 **:data-flux-badge-icon:me-1.5',
        'sm' => 'text-xs px-2 py-1 **:data-flux-badge-icon:size-3 **:data-flux-badge-icon:me-1',
        'xs' => 'text-xs px-2 py-0.5 **:data-flux-badge-icon:size-3 **:data-flux-badge-icon:me-1',
    })
    ->add(match ($variant) {
        'pill' => 'rounded-full',
        default => 'rounded-md',
    ...
    ->add($variant === 'solid' ? match ($color) {
        ...
        'accent' => 'text-white bg-accent [&:is(button)]:hover:bg-accent/80',
