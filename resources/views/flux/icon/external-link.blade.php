...
<svg {{ $attributes->class($classes) }} data-flux-icon xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="currentColor" aria-hidden="true" data-slot="icon">
  <path fill-rule="evenodd" d="M3.5 4.75a.75.75 0 0 0-.75.75v6c0 .414.336.75.75.75h6a.75.75 0 0 0 .75-.75v-3a.75.75 0 0 1 1.5 0v3A2.25 2.25 0 0 1 9.5 13.5h-6a2.25 2.25 0 0 1-2.25-2.25v-6A2.25 2.25 0 0 1 3.5 3h3a.75.75 0 0 1 0 1.5h-3Z" clip-rule="evenodd"/>
  <path fill-rule="evenodd" d="M9.75 4.5a.75.75 0 0 1 .75-.75h4a.75.75 0 0 1 .75.75v4a.75.75 0 0 1-1.5 0V5.56L9.03 10.28a.75.75 0 0 1-1.06-1.06l4.72-4.72H10.5a.75.75 0 0 1-.75-.75Z" clip-rule="evenodd"/>
</svg>
